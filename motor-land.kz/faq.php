...
$faq_schema_entities = [
	['q' => 'Что такое контрактный двигатель?', 'a' => 'Контрактный двигатель — это бывший в употреблении двигатель, снятый с автомобиля в рабочем состоянии и прошедший проверку перед продажей.'],
	['q' => 'Откуда привозятся контрактные двигатели?', 'a' => 'Мы привозим контрактные двигатели из Малайзии и других стран Азии, где условия эксплуатации обычно более щадящие.'],
	['q' => 'Как проверить состояние контрактного двигателя перед покупкой?', 'a' => 'Рекомендуется проверить компрессию, отсутствие подтеков, состояние масла, комплектность и соответствие номера двигателя.'],
	['q' => 'Какой срок гарантии на контрактные двигатели?', 'a' => 'Срок проверки обычно от 3 до 25 календарных дней, а для спортивных автомобилей — 5 дней.'],
	['q' => 'В каких случаях гарантия не действует?', 'a' => 'Гарантия не действует при неправильной установке, перегреве, внешних повреждениях, использовании нештатных деталей и нарушении условий эксплуатации.'],
	['q' => 'Что делать, если двигатель не подошел?', 'a' => 'Мы предлагаем замену на аналог, поставку под заказ или возврат средств при отсутствии подходящего двигателя.'],
	['q' => 'Как осуществляется доставка контрактных двигателей?', 'a' => 'Доставка осуществляется транспортными компаниями по Казахстану и СНГ, также доступен самовывоз и доставка по Алматы.'],
	['q' => 'Какие способы оплаты доступны?', 'a' => 'Доступны наличная и безналичная оплата, банковский перевод, онлайн-оплата картой и оплата через Kaspi.'],
	['q' => 'Какие сроки доставки?', 'a' => 'Сроки зависят от региона: по Алматы обычно 1–2 дня, по Казахстану 3–7 дней, по СНГ 7–14 дней.'],
	['q' => 'Где можно установить контрактный двигатель?', 'a' => 'Рекомендуется установка в сертифицированном сервисе. Также доступна установка в нашем автосервисе.'],
	['q' => 'Что входит в услугу установки двигателя?', 'a' => 'В услугу входит демонтаж/монтаж, подключение систем, замена расходников, диагностика и проверка работоспособности.'],
	['q' => 'Сколько стоит установка контрактного двигателя?', 'a' => 'Стоимость зависит от марки автомобиля, типа двигателя, сложности работ и дополнительных операций.'],
	['q' => 'Как подобрать контрактный двигатель для моего автомобиля?', 'a' => 'Для подбора нужны марка, модель, год, VIN и параметры двигателя; наши специалисты помогут с подбором.'],
	['q' => 'Совместим ли контрактный двигатель с моим автомобилем?', 'a' => 'Мы подбираем двигатель по техническим параметрам и совместимости с системой управления, трансмиссией и креплениями.'],
	['q' => 'Есть ли в наличии двигатель для моей модели?', 'a' => 'В наличии есть двигатели для популярных марок; при отсутствии нужной позиции организуем поставку под заказ.'],
];
?>
<!doctype html>
<html lang="ru">
...
<?php
$faq_main_entity = [];
foreach ($faq_schema_entities as $item) {
	$faq_main_entity[] = [
		'@type' => 'Question',
		'name' => $item['q'],
		'acceptedAnswer' => [
