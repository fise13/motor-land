...
// SEO: Оптимизированные мета-теги для страницы акций
$SITE_TITLE = 'Моторленд | Акции на контрактные Моторы и КПП';
$SITE_DESCRIPTION = 'Акции и спецпредложения на контрактные моторы и КПП в Алматы. Скидки на привозные двигатели из Малайзии. Контрактные двигатели Казахстан по выгодным ценам. Ограниченные предложения.';
$SITE_KEYWORDS = 'акции контрактные моторы, скидки на двигатели алматы, спецпредложения КПП, акции двигателей бу';
?>
<!doctype html>
<html>
<head>
