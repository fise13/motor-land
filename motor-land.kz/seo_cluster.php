...
$SITE_TITLE = 'Купить ' . htmlspecialchars($cluster_name, ENT_QUOTES, 'UTF-8') . ' в Алматы | Контрактные двигатели | Motor Land';
$SITE_DESCRIPTION = 'Каталог контрактных двигателей ' . htmlspecialchars($cluster_name, ENT_QUOTES, 'UTF-8') . ' в Алматы. Привозные моторы из Малайзии с гарантией. Большой выбор двигателей. Быстрая доставка по Казахстану.';
$SITE_KEYWORDS = mb_strtolower($cluster_name) . ', купить контрактный двигатель алматы, привозные моторы, двигатель бу малайзия';
?>
<!doctype html>
<html lang="ru">
<head>
