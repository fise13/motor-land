...
// SEO: Оптимизированные мета-теги для кластера (без эмодзи в title)
$cluster_name_clean = htmlspecialchars(trim($cluster_name), ENT_QUOTES, 'UTF-8');
// Оптимизируем длину title (55-60 символов)
$title_cluster = mb_strlen($cluster_name_clean) > 30 ? mb_substr($cluster_name_clean, 0, 27) . '...' : $cluster_name_clean;
$SITE_TITLE = 'Купить ' . $title_cluster . ' в Алматы | Motor Land';
$SITE_DESCRIPTION = 'Каталог контрактных двигателей ' . $cluster_name_clean . ' в Алматы. Привозные моторы из Малайзии с гарантией. Большой выбор двигателей. Быстрая доставка по России, Казахстану, Беларуси, Украине и всем странам СНГ.';
...
$SITE_KEYWORDS = mb_strtolower($cluster_name_clean) . ', купить контрактный двигатель алматы, привозные моторы, двигатель бу, контрактные двигатели, доставка двигателей СНГ';
?>
<!doctype html>
<html lang="ru">
<head>
