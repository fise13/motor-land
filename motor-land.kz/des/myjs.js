...
(function() {
	...
	function closeDropdown(dd) {
		if (dd.hasClass('open')) {
			...
			dd.css({
				...
				easing: 'swing',
				complete: function() {
					// Восстанавливаем исходное позиционирование
	...
	function openDropdown(dd) {
		...
		// Для dropdown внутри .sliderform используем absolute позиционирование
		// Слайдер имеет z-index: 200, который выше секции консультации (100)
		// Поэтому dropdown будет в правильном stacking context
		if (dd.closest('.sliderform').length) {
			...
			dd.css({
				...
				'z-index': '1001', // Выше формы поиска (1000), в контексте слайдера (200)
