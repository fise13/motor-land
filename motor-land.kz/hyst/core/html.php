...
function hyst_show_adm () {
	...
	if ($_HYST_ADMIN_SETUP) {
		...
		$html .= '<adm_header><label for="sidebarbutton"><i></i></label><div class="admin_header_profile"><div class="admin_header_name">'.$_HYST_ADMIN[AUC_PREFIX.'_name'].'</div><a class="admin_header_exit" href="?exit_admin">Выход</a></div></adm_header>';
		$html .= '<adm_content>';
		$html .= '<sidebar>
