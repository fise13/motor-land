...
<p>Все товары поставляются с документами, подтверждающими покупку, которые необходимы для гарантийного обслуживания.</p>
		...
		['guarantees_page', 'Гарантии', 'Гарантия на Контрактные Двигатели и КПП', '<div class="guarantee-hero">
<h2>Надежная гарантия на контрактные двигатели и КПП</h2>
<p>Компания Motor Land предоставляет комплексную гарантию на всю реализуемую продукцию. Мы уверены в качестве наших контрактных двигателей и коробок передач, поэтому предлагаем выгодные условия гарантийного обслуживания для всех наших клиентов.</p>
</div>

<div class="guarantee-section">
<h3>Гарантийные условия на двигатели</h3>
<p>На все контрактные двигателя, кроме турбированных Subaru, мы предоставляем срок на проверку от <strong>3 до 25 календарных дней</strong> со дня покупки без ограничения пробега. Это дает вам достаточно времени для полной проверки агрегата на сервисе и выявления возможных недостатков.</p>
<p>В течение гарантийного периода мы берем на себя полную ответственность за качество двигателя. Если при проверке обнаружены несоответствия заявленным параметрам или заводские дефекты, мы осуществляем:</p>
<ul>
<li>Бесплатную замену на аналогичный двигатель</li>
<li>При отсутствии аналогичного двигателя в наличии - привозим под заказ</li>
<li>Полный возврат денежных средств за товар</li>
</ul>
</div>

<div class="guarantee-section">
<h3>Гарантия на коробки передач</h3>
<p>На все коробки передач (АКПП и МКПП), кроме установленных на спортивных авто, распространяется срок на проверку от <strong>3 до 20 календарных дней</strong> со дня покупки.</p>
<p><strong>Важно:</strong> При замене АКПП обязательными должны быть заменены фильтры и масло. В случае установки КПП без замены масла или фильтра гарантия становится недействительной. Это требование связано с тем, что старое масло может содержать продукты износа, которые могут повредить новую коробку передач.</p>
<p>Для спортивных авто срок на проверку составляет <strong>5 дней</strong> с момента покупки при тех же условиях.</p>
</div>

<div class="guarantee-section">
<h3>Гарантия на навесное оборудование</h3>
<p>На навесное оборудование, а также комплектующие двигателя, подлежащие периодической замене в рамках ТО (ремни, датчики, фильтры, сальники, ролики, термостат, водяная помпа, термомуфта и т.д.) гарантия не распространяется, так как это расходные материалы с ограниченным сроком службы.</p>
<p>Исключение составляет ТНВД (топливный насос высокого давления) дизельных двигателей, на который распространяются те же условия гарантии, что и на основной агрегат.</p>
</div>

<div class="guarantee-section">
<h3>Гарантия на запчасти б/у</h3>
<p>Гарантия на запчасти б/у распространяется лишь при установке в сертифицированных сервисах в течение от <strong>3 до 25 дней</strong> с момента продажи товара. Это требование необходимо для обеспечения правильной установки и диагностики, что исключает возможность повреждения при монтаже.</p>
</div>

<div class="guarantee-section">
<h3>Условия возврата</h3>
<p>В случае возврата агрегата или запчасти мы гарантируем возврат его стоимости в течение <strong>3 рабочих дней</strong> или обмен на аналогичный товар.</p>
<p><strong>Важно знать:</strong> Транспортные издержки, стоимость работ и прочие накладные расходы не возмещаются. Б/у агрегаты не подлежат обмену или возврату в случаях пропуска срока, данного на проверку.</p>
<p>Возврат денежных средств производится только в случае отсутствия аналогичной детали на складе. В ином случае денежные средства не возвращаются, но мы всегда предложим альтернативное решение.</p>
...
</div>', 'Гарантии на Контрактные Двигатели и КПП | Моторленд', 'Гарантии на контрактные двигатели и КПП в Алматы. Полная гарантия от 3 до 25 дней. Возврат и обмен в течение гарантийного срока.', 'гарантия на контрактные двигатели, гарантия на КПП, возврат двигателя, обмен двигателя, гарантия на мотор']
	];
