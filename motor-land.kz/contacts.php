...
<body>
<?php 
// Вставка head (шапка сайта)
if (file_exists("des/head.php")) {
    ...
    <div class="shirina">
        ...
        <div class="inline-contacts">
            <div class="foterconicon" style="background-image: url(./img/tel.png);">
                <a href="tel:+77273466699" onclick="gtag('event', 'conversion', {'send_to': 'AW-17661940869/8IrgCNzqw7QbEIWp7-VB'});">+7 727 346 66 99</a>
                <br>
                <a href="tel:+77771445445" onclick="gtag('event', 'conversion', {'send_to': 'AW-17661940869/8IrgCNzqw7QbEIWp7-VB'});">+7 777 1445 445</a>
            </div>
        </div>
        <div class="inline-contacts">
...
<br><br>
<?php 
// Вставка foter (футер сайта)
if (file_exists("des/foter.php")) {
    include("des/foter.php");
} else {
    echo "<!-- foter.php not found -->";
}
?>
